...
//━━━━━━━━━━━━━━━[ CONNECTION 1 ]━━━━━━━━━━━━━━━━━//
		...
		mess = {
			...
			success: 'Done Jangan Lupa Subscribe Fazrin Ezz',
			error: {
...
var ase = new Date();
        ...
        const listmsg = (from, title, desc, list) => { // ngeread nya pake rowsId, jadi command nya ga keliatan
            let po = zeroyt7.prepareMessageFromContent(from, {"listMessage": {"title": title,"description": desc,"buttonText": "LIST MENU","footerText": "Subscribe Youtube Fazrin Ezz\nSupport Me To 100K Subscribe","listType": "SINGLE_SELECT","sections": list}}, {})
	...
	key : {
       ...
       message: {
                    orderMessage: {
                            ...
                            status: 1,
                            surface : 1,
                            message: `SUBSCRIBE FAZRIN EZZ`, 
                            orderTitle: `SUBSCRIBE FAZRIN EZZ`,
...
*┗━━━━━━━ •*`
        ...
        sendButton(from, teks, '©Created : Fazrin Ezz', but, mek)
break
case 'sewat':
...
costum(buffer, sticker, Verived, `Jangan Lupa Subscribe Fazrin Ezz`)
fs.unlinkSync(media)
fs.unlinkSync(ran)
})
...
buffer = fs.readFileSync(ran)
costum(buffer, image, Verived, `Jangan Lupa Subscribe Fazrin Ezz`)
fs.unlinkSync(ran)
})
break
case 'tomp3':
...
fs.unlinkSync(anum)
buffer = fs.readFileSync(ran)
zeroyt7.sendMessage(from, buffer, video, { quoted: ftrol, caption: 'Done... Jangan Lupa Subscribe Fazrin Ezz' })
fs.unlinkSync(ran)
})
break
...
case 'instagram':
teks =
`Nih Instagram Owner Ku Jangan Lupa Di Follow Ya https://instagram.com/fazrin_ezz`
zeroyt7.sendMessage(from, teks, text, {quoted: ftrol})
break
case 'tiktok':
teks =
`Nih Tiktok Owner Ku Jangan Lupa Di Follow Ya https://tiktok.com/@fazrin_ezz`
zeroyt7.sendMessage(from, teks, text, {quoted: ftrol})
break
case 'sourcecode':
case 'script':
...
├─────────────────────
├ Creator Base = Fazrin Ezz
├ Creator Sc = Fazrin Ezz
└─────────────────────`
zeroyt7.sendMessage(from, teks, text, {quoted: ftrol})
break
case "on":
...
//━━━━━━━━━━━━━━━[ FITUR MAKER ]━━━━━━━━━━━━━━━━━//
        ...
        break
        case "sertiff1":
        if (args.length < 1) return reply(`Teksnya Mana Tod ?\nContoh: ${prefix + command}Fazrin Ezz`)
        pll = body.slice(10);
        reply("Loading.....");
        ...
        case "googlem":
				...
				if (args.length < 1) return reply(`Teksnya Mana Tod ?\nContoh: ${prefix + command}Fazrin Ezz | ganteng | banget`)
				reply(mess.wait)
kontol = body.slice(8)
...
//━━━━━━━━━━━━━━━[ FITUR RANDOM IMAGE ]━━━━━━━━━━━━━━━━━//
      ...
      case "aeshtetic":
      case "wallpaperanime":
      sendButton(from, `Random Image By Fazrin Ezz`, `press the button below`, [
          {
...
reply(mess.wait)
zeroyt7.sendMessage(from, gambar, image, { quoted: ftrol, caption: 'Nih Jangan Lupa Subscribe Fazrin Ezz'})
})
break
default:
if (isOwner) {
