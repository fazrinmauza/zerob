...
//━━━━━━━━━━━━━━━[ CONNECTION 1 ]━━━━━━━━━━━━━━━━━//
		...
		mess = {
			...
			success: 'Done Jangan Lupa Subscribe ALIF STORE',
			error: {
...
var ase = new Date();
        ...
        const listmsg = (from, title, desc, list) => { // ngeread nya pake rowsId, jadi command nya ga keliatan
            let po = zeroyt7.prepareMessageFromContent(from, {"listMessage": {"title": title,"description": desc,"buttonText": "LIST MENU","footerText": "Subscribe Youtube ALIF STORE\nSupport Me To 100K Subscribe","listType": "SINGLE_SELECT","sections": list}}, {})
	...
	key : {
       ...
       message: {
                    orderMessage: {
                            ...
                            status: 1,
                            surface : 1,
                            message: `SUBSCRIBE ALIF STORE`, 
                            orderTitle: `SUBSCRIBE ALIF STORE`,
...
*┗━━━━━━━ •*`
        ...
        sendButton(from, teks, '©Created : ALIF STORE', but, mek)
break
case 'sewat':
...
costum(buffer, sticker, Verived, `Jangan Lupa Subscribe ALIF STORE`)
fs.unlinkSync(media)
fs.unlinkSync(ran)
})
...
buffer = fs.readFileSync(ran)
costum(buffer, image, Verived, `Jangan Lupa Subscribe ALIF STORE`)
fs.unlinkSync(ran)
})
break
case 'tomp3':
...
fs.unlinkSync(anum)
buffer = fs.readFileSync(ran)
zeroyt7.sendMessage(from, buffer, video, { quoted: ftrol, caption: 'Done... Jangan Lupa Subscribe ALIF STORE' })
fs.unlinkSync(ran)
})
break
...
╭─────────────────────
├ Sc Ori = zero vip
├ Sc Full Fitur = https://youtube.com/channel/UCpbpBidDtXnAg4XcPSKEdNg
├─────────────────────
├ Creator Base = ALIF STORE
├ Creator Sc = ALIF STORE
└─────────────────────`
zeroyt7.sendMessage(from, teks, text, {quoted: ftrol})
break
case "on":
...
//━━━━━━━━━━━━━━━[ FITUR MAKER ]━━━━━━━━━━━━━━━━━//
        ...
        break
        case "sertiff1":
        if (args.length < 1) return reply(`Teksnya Mana Tod ?\nContoh: ${prefix + command}ALIF STORE`)
        pll = body.slice(10);
        reply("Loading.....");
        ...
        case "googlem":
				...
				if (args.length < 1) return reply(`Teksnya Mana Tod ?\nContoh: ${prefix + command}ALIF STORE | ganteng | banget`)
				reply(mess.wait)
kontol = body.slice(8)
...
//━━━━━━━━━━━━━━━[ FITUR RANDOM IMAGE ]━━━━━━━━━━━━━━━━━//
      ...
      case "aeshtetic":
      case "wallpaperanime":
      sendButton(from, `Random Image By ALIF STORE`, `press the button below`, [
          {
...
reply(mess.wait)
zeroyt7.sendMessage(from, gambar, image, { quoted: ftrol, caption: 'Nih Jangan Lupa Subscribe ALIF STORE'})
})
break
default:
if (isOwner) {
